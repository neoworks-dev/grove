...
<div
  class="group flex w-full cursor-pointer items-center gap-1 py-[3px] pr-2 text-xs text-muted select-none hover:bg-hover"
...
>
  ...
  <span class="shrink-0 font-mono text-2xs text-dim group-hover:hidden">{row.fileCount}</span>
</div>
