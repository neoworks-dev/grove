// Vendored from nib (web/src/renderer/lib/tools.ts) and reformatted to grove's
// style. Reformatting is the only change beyond dropping nib's Shiki dependency:
// grove renders code through markdown fences, so a language id is a label rather
// than a grammar to load.
//
/**
